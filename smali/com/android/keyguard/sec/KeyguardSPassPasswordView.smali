...
.method protected verifySpassPasswordAndUnlock()V
    ...
    invoke-virtual {v6, v1}, Lcom/android/internal/widget/LockPatternUtils;->checkFingerprintPassword(Ljava/lang/String;)Z
    ...
    .line 317
    iget-object v6, p0, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;
    ...
    invoke-virtual {v6, v9}, Lcom/android/internal/widget/LockPatternUtils;->setPermanentlyLocked(Z)V
    ...
    invoke-virtual {v6, v7, v9}, Landroid/view/inputmethod/InputMethodManager;->hideSoftInputFromWindow(Landroid/os/IBinder;I)Z
    ...
    const-string v6, "com.samsung.android.intent.action.FINGERPRINT_UNLOCKED_BY_PASSWORD"
    ...
    :goto_0
    invoke-virtual {p0, v8}, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->resetPasswordText(Z)V
    ...
    .line 330
    iget-object v6, p0, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->mContext:Landroid/content/Context;

    invoke-static {v6}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getInstance(Landroid/content/Context;)Lcom/android/keyguard/KeyguardUpdateMonitor;

    move-result-object v6

    iget-object v7, p0, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v7}, Lcom/android/internal/widget/LockPatternUtils;->getCurrentUser()I

    move-result v7

    invoke-virtual {v6, v7, v8}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getFailedUnlockAttempts(IZ)I
    ...
    :cond_2
    :goto_1
    iget-object v6, p0, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;

    invoke-virtual {p0}, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->getWrongPasswordStringId()I

    move-result v7

    invoke-virtual {p0, v7, v0}, Lcom/android/keyguard/sec/KeyguardSPassPasswordView;->getFailedAttemptMessage(II)Ljava/lang/CharSequence;
